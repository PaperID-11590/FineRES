...
class ValDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if len(splits) == 2:
            ...
            if ds == "MultiPartReasonSeg":
                ...
                json_file_name = "/data_16T/tc/huliwen/MMR-main/diangong_annotations_1203_special_fence_simple.json"
    ...
    def __getitem__(self, idx):
        if self.data_type == "refer_seg":
            ...
            image_path = os.path.join("/data_16T/tc/lilu/qwen3vl/CoTF/results_data1w_renamed_new_label/test_msec/visualization/ME", image_info['img_name'])
        ...
        labels = torch.ones(self.image_h, self.image_w) * self.ignore_label
        inference = True
